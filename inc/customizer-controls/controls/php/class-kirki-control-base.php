...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected'   => esc_attr__( 'No File Selected', 'elexis' ),
				'remove'           => esc_attr__( 'Remove', 'elexis' ),
				'default'          => esc_attr__( 'Default', 'elexis' ),
				'selectFile'       => esc_attr__( 'Select File', 'elexis' ),
				'standardFonts'    => esc_attr__( 'Standard Fonts', 'elexis' ),
				'googleFonts'      => esc_attr__( 'Google Fonts', 'elexis' ),
				'defaultCSSValues' => esc_attr__( 'Default CSS Values', 'elexis' ),
			)
		);
