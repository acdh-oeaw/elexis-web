...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'elexis' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'elexis' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'elexis' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'elexis' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'elexis' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'elexis' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'elexis' ); ?>',
		} );
		#>
		<label>
