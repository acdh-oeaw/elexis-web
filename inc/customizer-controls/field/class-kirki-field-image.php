...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'elexis' ),
				'change'       => esc_attr__( 'Change image', 'elexis' ),
				'default'      => esc_attr__( 'Default', 'elexis' ),
				'remove'       => esc_attr__( 'Remove', 'elexis' ),
				'placeholder'  => esc_attr__( 'No image selected', 'elexis' ),
				'frame_title'  => esc_attr__( 'Select image', 'elexis' ),
				'frame_button' => esc_attr__( 'Choose image', 'elexis' ),
			)
		);
	}
