...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'elexis' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'elexis' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'elexis' ),
			'200'       => esc_attr__( 'Light 200', 'elexis' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'elexis' ),
			'300'       => esc_attr__( 'Book 300', 'elexis' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'elexis' ),
			'400'       => esc_attr__( 'Normal 400', 'elexis' ),
			'regular'   => esc_attr__( 'Normal 400', 'elexis' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'elexis' ),
			'500'       => esc_attr__( 'Medium 500', 'elexis' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'elexis' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'elexis' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'elexis' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'elexis' ),
			'700'       => esc_attr__( 'Bold 700', 'elexis' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'elexis' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'elexis' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'elexis' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'elexis' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'elexis' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'elexis' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'elexis' ),
		);
	}
