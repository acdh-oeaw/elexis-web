 ...
 */
if (!function_exists('elexis_pagination')) :

    function elexis_pagination() {
        if (is_singular()) {
            return;
        }
        ...
        if (!in_array(1, $links)) {
            ...
            printf('<li %s><a class="page-link" href="%s"><i class="fa fa-step-backward" aria-hidden="true"></i>%s</a></li>' . "\n",
        ...
        if (!in_array($max, $links)) {
            ...
            printf('<li %s><a class="page-link" href="%s" aria-label="Next"><span aria-hidden="true"><i class="fa fa-step-forward" aria-hidden="true"></i></span><span class="sr-only"></span>%s</a></li>' . "\n",
                    $class . '', esc_url(get_pagenum_link(esc_html($max))), esc_html((string) $max));
        }
