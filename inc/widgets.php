 ...
 */
if ( ! function_exists( 'elexis_slbd_count_widgets' ) ) {
	function elexis_slbd_count_widgets( $sidebar_id ) {
...
if ( ! function_exists( 'elexis_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function elexis_widgets_init() {
...
} // endif function_exists( 'elexis_widgets_init' ).
add_action( 'widgets_init', 'elexis_widgets_init' );
